...
const (
	Properties_AddProperty_FullMethodName            = "/nanafs.v1.Properties/AddProperty"
	Properties_DeleteProperty_FullMethodName         = "/nanafs.v1.Properties/DeleteProperty"
...
type PropertiesClient interface {
	AddProperty(ctx context.Context, in *AddPropertyRequest, opts ...grpc.CallOption) (*GetPropertiesResponse, error)
	DeleteProperty(ctx context.Context, in *DeletePropertyRequest, opts ...grpc.CallOption) (*GetPropertiesResponse, error)
...
func (c *propertiesClient) AddProperty(ctx context.Context, in *AddPropertyRequest, opts ...grpc.CallOption) (*GetPropertiesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *propertiesClient) DeleteProperty(ctx context.Context, in *DeletePropertyRequest, opts ...grpc.CallOption) (*GetPropertiesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPropertiesResponse)
...
type PropertiesServer interface {
	AddProperty(context.Context, *AddPropertyRequest) (*GetPropertiesResponse, error)
	DeleteProperty(context.Context, *DeletePropertyRequest) (*GetPropertiesResponse, error)
...
func (UnimplementedPropertiesServer) AddProperty(context.Context, *AddPropertyRequest) (*GetPropertiesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddProperty not implemented")
}
func (UnimplementedPropertiesServer) DeleteProperty(context.Context, *DeletePropertyRequest) (*GetPropertiesResponse, error) {
