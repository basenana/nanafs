...
func (c *inboxClient) QuickInbox(ctx context.Context, in *QuickInboxRequest, opts ...grpc.CallOption) (*QuickInboxResponse, error) {
	...
	err := c.cc.Invoke(ctx, Inbox_QuickInbox_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedInboxServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedInboxServer) testEmbeddedByValue() {}
...
func RegisterInboxServer(s grpc.ServiceRegistrar, srv InboxServer) {
	// If the following call pancis, it indicates UnimplementedInboxServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (c *notifyClient) GetLatestSequence(ctx context.Context, in *GetLatestSequenceRequest, opts ...grpc.CallOption) (*GetLatestSequenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, Notify_GetLatestSequence_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notifyClient) ListUnSyncedEvent(ctx context.Context, in *ListUnSyncedEventRequest, opts ...grpc.CallOption) (*ListUnSyncedEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, Notify_ListUnSyncedEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notifyClient) CommitSyncedEvent(ctx context.Context, in *CommitSyncedEventRequest, opts ...grpc.CallOption) (*CommitSyncedEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, Notify_CommitSyncedEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
