...
func (c *propertiesClient) AddProperty(ctx context.Context, in *AddPropertyRequest, opts ...grpc.CallOption) (*GetPropertiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nanafs.v1.Properties/AddProperty", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *propertiesClient) DeleteProperty(ctx context.Context, in *DeletePropertyRequest, opts ...grpc.CallOption) (*GetPropertiesResponse, error) {
	out := new(GetPropertiesResponse)
	err := c.cc.Invoke(ctx, "/nanafs.v1.Properties/DeleteProperty", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Properties_AddProperty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nanafs.v1.Properties/AddProperty",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Properties_DeleteProperty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nanafs.v1.Properties/DeleteProperty",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
