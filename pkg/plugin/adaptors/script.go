...
func NewScriptPluginAdaptor(spec types.PluginSpec, pcall types.PluginCall) (*ScriptPluginAdaptor, error) {
	return &ScriptPluginAdaptor{spec: spec, pcall: pcall, logger: logger.NewLogger("scriptPluginAdaptor")}, nil
}
