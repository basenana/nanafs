...
[![Build Status](https://travis-ci.org/wangbin/jiebago.png?branch=master)](https://travis-ci.org/wangbin/jiebago) [![GoDoc](https://godoc.org/github.com/hyponet/jiebago?status.svg)](https://godoc.org/github.com/hyponet/jiebago)
...
```
go get github.com/hyponet/jiebago/...
```
...
更多信息请参考[文档](https://godoc.org/github.com/hyponet/jiebago)。
