...
var (
	...
	downloads = []struct {
		...
		{sqliteDir, "https://www.sqlite.org/2022/sqlite-amalgamation-3380300.zip", 2457, false},
		{sqliteSrcDir, "https://www.sqlite.org/2022/sqlite-src-3380300.zip", 12814, false},
	}

	sqliteDir    = filepath.FromSlash("testdata/sqlite-amalgamation-3380300")
	sqliteSrcDir = filepath.FromSlash("testdata/sqlite-src-3380300")
)
